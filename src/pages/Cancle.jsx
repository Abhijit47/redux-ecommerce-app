...
const Cancle = () => {
  return (
    <div className='bg-gray-100 h-[85dvh] flex justify-center items-center'>
      <div className='bg-white p-6  md:mx-auto'>
        ...
        <div className='text-center'>
          ...
          <div className='py-10 text-center'>
            <Link
              to='/'
              className='px-12 bg-red-600 hover:bg-red-500 text-white font-semibold py-3 rounded-md'>
              GO BACK
            </Link>
          </div>
        </div>
